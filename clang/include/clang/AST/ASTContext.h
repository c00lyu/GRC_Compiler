...
class ASTContext : public RefCountedBase<ASTContext> {
  ...
  FunctionDecl *GrcConfigureCallDecl;
...
public:
  ...
  void setGrcConfigureCallDecl(FunctionDecl *FD) {
    GrcConfigureCallDecl = FD;
  }
  FunctionDecl *getGrcConfigureCallDecl() {
    return GrcConfigureCallDecl;
  }
