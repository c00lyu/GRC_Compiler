...
public:
  ...
  ExprResult ParseExpression(TypeCastState isTypeCast = NotTypeCast,bool IsSyn = true);
  ExprResult ParseConstantExpression(TypeCastState isTypeCast = NotTypeCast);
  // Expr that doesn't include commas.
  ExprResult ParseAssignmentExpression(TypeCastState isTypeCast = NotTypeCast,bool IsSyn = true);
...
private:
  ...
  ExprResult ParsePostfixExpressionSuffix(ExprResult LHS,bool IsSyn=true);
  ...
  StmtResult ParseStatementOrDeclarationAfterAttributes(
                                         ...
                                         ParsedAttributesWithRange &Attrs);
  StmtResult ParseExprStatement(bool IsSyn = true);
  ...
  StmtResult ParseGRForStatement(SourceLocation *TrailingElseLoc);
