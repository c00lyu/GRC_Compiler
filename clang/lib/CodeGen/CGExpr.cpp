...
RValue CodeGenFunction::EmitCallExpr(const CallExpr *E,
  ...
  if (const GrcTaskCallExpr *CE = dyn_cast<GrcTaskCallExpr>(E))
    return EmitGrcTaskCallExpr(CE, ReturnValue);
...
RValue CodeGenFunction::EmitCall(QualType CalleeType, llvm::Value *Callee,
  ...
  return EmitCall(FnInfo, Callee, ReturnValue, Args, TargetDecl,0,CE);
}
