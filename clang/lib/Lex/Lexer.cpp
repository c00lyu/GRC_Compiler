...
FinishIdentifier:
    ...
    //std::cout <<"raw: " << Result.getName() << std::endl;
    ...
    // std::cout <<"actual: " << Result.getName() << std::endl;
...
/*
  ...
  if(Result.isLiteral())
	  std::cout << Result.getLiteralData();
  std::cout << std::endl;
  */
  ...
  case '<':
    ...
    if (ParsingFilename) {
      ...
      if (After == '=') {
        ...
        // ignore it.
        goto LexNextToken;
      } else if ((LangOpts.CUDA || LangOpts.GRC) && After == '<') {
